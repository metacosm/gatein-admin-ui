...
<head>
   <title><%=res.getString("UILoginForm.label.Signin")%>
   </title>
...
<div class="UILogin">
   <div class="LoginHeader"><%=res.getString("UILoginForm.label.Signin")%>
   </div>
   <div class="LoginContent">
      <div class="WelcomeText"><%=res.getString("UILoginForm.label.welcome")%>
      </div>
      <div class="CenterLoginContent">
         ...
         %>
         <font color="red"><%=res.getString("UILoginForm.label.SigninFail")%>
         </font><%}%>
         <form class="ClearFix" name="loginForm" action="<%= contextPath + "/login"%>" method="post"
               style="margin: 0px;">
            <% if (uri != null)
            {
...
<span
   style="margin: 10px 0px 0px 5px; font-size: 11px; color: #6f6f6f; text-align: center"><%=res.getString("UILoginForm.label.Copyright")%></span>
</body>
</html>
